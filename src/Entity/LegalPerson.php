...
class LegalPerson
{
    ...
    /**
     * @ORM\OneToOne(targetEntity=NaturalPerson::class, inversedBy="mainLegalPerson", cascade={"persist"})
     */
    private $mainRepresentative;

    /**
     * @ORM\OneToOne(targetEntity=NaturalPerson::class, inversedBy="secondLegalPerson", cascade={"persist"})
     */
    private $secondRepresentative;

    /**
     * @ORM\ManyToMany(targetEntity=Address::class, mappedBy="legalPerson", cascade={"persist", "remove"})
     */
    private $addresses;
    ...
    public function mainLegalPersonne()
    {
        return $this->mainRepresentative;
    }
}
